	...
	function cs_accordions_page(){
		...
		$html .= '</div>';
			...
			$html = '<div class="element_size_'.$cs_node->accordion_element_size.'">';
				$html .= '<div class="panel-group fullwidth accordion" id="accordion-' . $acc_counter . '">';
					foreach ( $cs_node->accordion as $cs_node ){
						...
						$html .= '<a class="accordion-toggle backcolorhover '.$class_active .'" data-toggle="collapse" data-parent="#accordion-' . $acc_counter . '" href="#accordion-' . str_replace(" ", "", $accordion_count . $acc_counter) . '"><i class="fa '.$cs_node->accordion_title_icon.'"></i> ' . $cs_node->accordion_title . '</a>';
						$html .= '</h4>';
						$html .= '</div>';
...
?>
      ...
      $('body') .css({"background":"url(<?php echo $theme_path?>/images/background/bg"+ah+".jpg) no-repeat center center / cover fixed"});
     });
            ...
            <div id="sidebar">
                <form method="post" id="color_switcher" action="">
                	...
                	<div class="buttonarea">
                        ...
                        <input type="hidden" name="reset_color_txt" id="reset_color_txt" value="#ff3f00" />
  		...
  		function widget($args, $instance) {
			...
			if(strlen($username) > 1){
				...
				<p class='twitter-follow'>
					<a href='http://www.twitter.com/".$username."' target='_blank' class='colrhover'>".$cs_theme_option['trans_follow_twitter']."</a>
					</p>

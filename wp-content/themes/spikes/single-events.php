                    ...
                    <div class="event-detail">
                        ...
                        <article class="detail-cont-right <?php if(empty($image_id) || $image_id == ''){ echo ' cs_fullwidth';}?>">
                            ...
                            <script>
                                ...
                                austDay = new Date(<?php echo date("Y", strtotime($cs_event_from_date));?>,<?php echo date("m", strtotime($cs_event_from_date))-1;?>,<?php echo date("d", strtotime($cs_event_from_date));?>,<?php echo $hours;?>,<?php echo $minute;?>);

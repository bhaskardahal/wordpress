	...
	jQuery("#sc_select").change(function() {
			var v = jQuery("#sc_select :selected").val();
					...
					if(v == 'toogle'){
                                        ...
                                        send_to_editor('[tab style="horizontal/vertical"] <br />\
                                       ...
                                       send_to_editor('[divider style="divider1" backtotop="yes" top_margin="20" bottom_margin="20"]<br /><br />');
                                        ...
                                        send_to_editor('[contact link="#" target="_blank" icon="fa-star" title="Booking" desc="111-222-333" ]<br /><br />');
                                }
                             else if(v == 'quote'){
                                        ...
                                        send_to_editor('[message_box align="left" icon="fa-info-sign" close="yes" color="#COLOR_CODE" background="#COLOR_CODE" border_color="#COLOR_CODE" box_shadow_color="#COLOR_CODE" title="Message Title"]Message Content[/message_box]<br /><br />');
                                }
                             else if(v == 'frame'){
                                        ...
                                        send_to_editor('[testimonials type="v1" ]<br />\
                                        ...
                                        send_to_editor('[team-sec style="team-v1"]<br />\

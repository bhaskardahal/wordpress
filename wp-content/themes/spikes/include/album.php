                ...
                <div class="boxes tracklists">
                	<div id="add_track" class="poped-up">
                        ...
                        <ul class="form-elements noborder">
                            ...
                            <li class="to-field"><input type="button" value="Add Track to List" onclick="add_track_to_list('<?php echo admin_url('admin-ajax.php')?>', '<?php echo get_template_directory_uri()?>')" /></li>
                        </ul>
                    </div>
                    <script>

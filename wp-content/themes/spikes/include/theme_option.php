...
<form id="frm" method="post" action="javascript:cs_theme_option_save('<?php echo admin_url('admin-ajax.php')?>', '<?php echo get_template_directory_uri()?>');">
      ...
      <div class="row"> 
          ...
          <div class="opt-head">
           ...
           <ul class="form-elements">
            ...
            <li class="to-field">
              ...
              <input type="text" id="consumer_key" name="consumer_key" value="<?php if(isset($cs_theme_option['consumer_key'])) echo $cs_theme_option['consumer_key'];  ?>"  class="{validate:{required:true}}"/>
            </li>
          </ul>
          <ul class="form-elements">
            <li class="to-label">
            ...
            <li class="to-field">
              ...
              <input type="text" id="consumer_secret" name="consumer_secret" value="<?php if(isset($cs_theme_option['consumer_secret'])) echo $cs_theme_option['consumer_secret']; ?>" class="{validate:{required:true}}"/>
            </li>
          </ul>
          <ul class="form-elements">
            <li class="to-label">
            ...
            <li class="to-field">
              ...
              <input type="text" id="access_token" name="access_token" value="<?php if(isset($cs_theme_option['access_token'])) echo $cs_theme_option['access_token']; ?>" class="{validate:{required:true}}"/>
            </li>
          </ul>
          <ul class="form-elements">
            <li class="to-label">
            ...
            <li class="to-field">
              ...
              <input type="text" id="access_token_secret" name="access_token_secret" value="<?php if(isset($cs_theme_option['access_token_secret'])) echo $cs_theme_option['access_token_secret']; ?>" class="{validate:{required:true}}"/>
            </li>
          </ul>
        ...
        <div id="tab-social-network" style="display:none;">
          ...
          <ul class="form-elements">
            ...
            <li class="to-field"><input type="button" value="Add" onclick="javascript:cs_add_social_icon('<?php echo admin_url('admin-ajax.php')?>')" /></li>
          </ul>
          <div class="opt-head">
        ...
        <div id="tab-import-export" style="display:none;">
          ...
          <ul class="form-elements">
            ...
            <li class="to-field">
              <input type="button" value="Restore Default" onclick="cs_to_restore_default('<?php echo admin_url('admin-ajax.php')?>', '<?php echo get_template_directory_uri()?>')" />
          ...
          <ul class="form-elements">
            ...
            <li class="to-field">
              <input type="button" value="Take Backup" onclick="cs_to_backup('<?php echo admin_url('admin-ajax.php')?>', '<?php echo get_template_directory_uri()?>')" />
            ...
            <li class="to-field">
              <input type="button" value="Restore Backup" onclick="cs_to_backup_restore('<?php echo admin_url('admin-ajax.php')?>', '<?php echo get_template_directory_uri()?>')" />

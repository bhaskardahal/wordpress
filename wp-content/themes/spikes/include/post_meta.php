        ...
        <div class="option-sec row">
            <div class="opt-conts">
                ...
                <ul class="form-elements" style="display:none;">
                    ...
                    <li class="to-field">
                        <input type="text" name="post_icon" value="<?php echo $post_icon?>" />
                        <p>
                            Put Awesome Font Code like "fa-flag". You can get others from 
...
<?php
		...
		if ( isset($_POST['post_meta_form']) and $_POST['post_meta_form'] == 1 ) {
			...
			function cs_meta_post_save( $cs_post_id ) {
				if( defined( 'DOING_AUTOSAVE' ) && DOING_AUTOSAVE ) return;
					if ( empty($_POST['post_social_sharing']) ) $_POST['post_social_sharing'] = "";
					if ( empty($_POST['post_icon']) ) $_POST['post_icon'] = "";
					...
					if (empty($_POST["post_social_sharing"])){ $_POST["post_social_sharing"] = "";}
						...
						$sxe = new SimpleXMLElement("<cs_meta_post></cs_meta_post>");
							...
							$sxe->addChild('post_icon', $_POST['post_icon'] );
 							$sxe = save_layout_xml($sxe);
				update_post_meta( $cs_post_id, 'post', $sxe->asXML() );
			}
		}
?>
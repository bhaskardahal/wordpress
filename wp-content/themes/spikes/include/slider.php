	...
	add_action('init', 'cs_slider_register');
		...
		// adding Slider meta info start
				...
				?>
                            ...
                            <div class="opt-conts-in">
                                <div class="to-social-network">
                                    <div class="gal-active">
                                        ...
                                        <div class="placehoder">Slider is Empty. Please Select Media <img src="<?php echo get_template_directory_uri()?>/images/admin/bg-arrowdown.png" alt="" /></div>
										<ul id="gal-sortable">
											<?php 
												$counter_slides = 0;
					...
					<script>
                        jQuery(document).ready(function($) {
                            ...
                            var counter = 0;
							var count_items = <?php echo $counter_slides?>;
							if ( count_items > 0 ) {
			...
			if ( isset($_POST['slider_meta_form']) and $_POST['slider_meta_form'] == 1 ) {
				...
				function cs_meta_slider_options( $cs_post_id )
				{
					$counter = 0;
					...
					update_post_meta( $cs_post_id, 'cs_meta_slider_options', $sxe->asXML() );
				}
			}
